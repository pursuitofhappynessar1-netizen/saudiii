  ...
  return (
    <div className="py-20 bg-white" dir="ltr">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-medium">6 - 8 September</span>
            </div>
            <div className="flex items-center gap-2">
              <MapPin className="w-6 h-6 text-teal-600" />
              <span className="text-lg font-medium">InterContinental Hotel - Taif</span>
            </div>
            <div className="flex items-center gap-2">
        ...
        {/* Speakers Grid */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-darkBlue-800 text-center mb-12">Distinguished Speakers</h2>
