...
import MediaCoverageAdmin from './components/admin/MediaCoverageAdmin';
...
import ExhibitionAdmin from './components/admin/ExhibitionAdmin';
    ...
    <Router>
      <Routes>
        ...
        <Route path="/" element={<Layout />}>
          ...
          <Route path="about/scientific-committee" element={<AboutScientificCommittee title="اللجنة العلمية" description="أعضاء اللجنة العلمية للمؤتمر وخبراتهم" />} />
