...
const SponsorshipForm = () => {
  ...
  return (
    <section id="book-sponsorship" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            كن جزءاً من هذا الحدث المهم وادعم مستقبل القطاع التعاوني في المملكة
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="animate-slide-up">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">باقات الرعاية</h3>
          ...
          <div className="animate-slide-up">
            <form onSubmit={handleSubmit} className="bg-gray-50 rounded-lg shadow-md p-8">
              ...
              <div className="mt-8">
                <button
                  type="submit"
                  className="w-full bg-accent-600 hover:bg-accent-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-200 transform hover:scale-105"
                >
                  إرسال طلب الرعاية
                </button>
              </div>
